intellisense.annotate(jQuery, {
  ...
  'browser': function() {
    /// <summary>Contains flags for the useragent, read from navigator.userAgent. This property was removed in jQuery 1.9 and is available  through the jQuery.migrate plugin. Please try to use feature detection instead.</summary>
    /// <returns type="PlainObject" />
  },
  'browser.version': function() {
    /// <summary>The version number of the rendering engine for the user's browser. This property was removed in jQuery 1.9 and is available  through the jQuery.migrate plugin.</summary>
    /// <returns type="String" />
  },
  'Callbacks': function() {
    /// <signature>
  ...
  'unique': function() {
    /// <signature>
    ///   <summary>Sorts an array of DOM elements, in place, with the duplicates removed. Note that this  works on arrays of DOM elements, not strings or numbers.</summary>
...
intellisense.annotate(jQuery.fn, {
  ...
  'class': function() {
    ...
    ///   <param name="class" type="String">A class to search for. An element can have multiple classes;  one of them must match.</param>
    /// </signature>
  },
  'clearQueue': function() {
    /// <signature>
  ...
  'next': function() {
    /// <signature>
    ///   <summary>Get the immediately following sibling of each element in the set of matched elements. If a selector is provided, it retrieves the next sibling  if it matches that selector.</summary>
    ///   <param name="selector" type="String">A string containing a selector expression to match elements against.</param>
    ///   <returns type="jQuery" />
    /// </signature>
  },
  ...
  '-child': function() {
    /// <summary>Selects all elements that are the  child of their parent.</summary>
  },
  '-of-type': function() {
