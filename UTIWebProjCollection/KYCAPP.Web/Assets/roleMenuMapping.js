app.controller("roleMenuMapping", ["$scope", "roleMenuMappingFactory", "$timeout", "$location", "$window","$validator", function ($scope, roleMenuMappingFactory, $timeout, $location, $window,$validator) {
