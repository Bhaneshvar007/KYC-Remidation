...
is not optional when Select is loaded, but its default is for selection  to
...
options object, allowing the developer to select  selected items or
unselected items.
...
apiRegister( 'select.style()', function ( style ) {
	...
	return this.iterator( 'table', function ( ctx ) {
		...
		// Add / remove mouse event handlers. They aren't required when 
...
apiRegisterPlural( 'cells().deselect()', 'cell().deselect()', function () {
	...
	this.iterator( 'cell', function ( ctx, rowIdx, colIdx ) {
		...
		// Remove class  if the cells exist, and the cell is not column
