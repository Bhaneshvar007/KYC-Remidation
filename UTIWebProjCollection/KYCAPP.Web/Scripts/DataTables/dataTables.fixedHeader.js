...
$.extend( FixedHeader.prototype, {
	 ...
	 * * `below` - (Header ) Fixed to the bottom of the table body
	 * * `above` - (Footer ) Fixed to the top of the table body
	 * 
	...
	_modeChange: function ( mode, item, forceChange )
	{
		...
		else if ( mode === 'below' ) { //  used for the header
		...
		else if ( mode === 'above' ) { //  used for the footer
