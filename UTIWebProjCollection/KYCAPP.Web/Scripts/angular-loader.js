 ...
 *
 * @param {Object=} config - The configuration object. May  contain the options that need to be
    ...
    return function module(name, requires, configFn) {
      ...
      return ensure(modules, name, function() {
        ...
        var moduleInstance = {
           ...
           * @description
           *
           * **NOTE**: animations take effect  if the **ngAnimate** module is loaded.
           *
           *
           ...
           *
           * Note that you can  inject {@link angular.Module#provider `providers`} and
