...
window.Modernizr = (function( window, document, undefined ) {
    ...
    /*
     * The Modernizr.touch test  indicates if the browser supports
    ...
    // For speed, we don't test the legacy (and beta-) indexedDB
    ...
    // Note, Android < 4 will pass this test, but can  animate
    ...
    tests['csstransforms3d'] = function() {
        ...
        if ( ret && 'webkitPerspective' in docElement.style ) {
          ...
          // Webkit allows this media query to succeed  if the feature is enabled.
    ...
    // This test is  for clip paths in SVG proper, not clip paths on HTML content
    ...
    function webforms() {
        ...
        //  input placeholder is tested while textarea's placeholder is not.
        // Currently Safari 4 and Opera 11 have support  for the input placeholder
    ...
    // usage:
    // Modernizr.mq(' screen and (max-width:768)')
