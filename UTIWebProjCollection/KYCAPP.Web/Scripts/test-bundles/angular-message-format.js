...
MessageFormatParser.prototype.errorExpecting = function errorExpecting() {
  ...
  if (word === 'select' || word === 'plural') {
    ...
    throw $interpolateMinErr('unknarg',
        'Unsupported keyword “{0}” at line {0}, column {1}.  “plural” and “select” are currently supported.  Text: “{3}”',
        word, position.line, position.column, this.text);
  }
};
...
MessageFormatParser.prototype.ruleInAngularExpression = function ruleInAngularExpression() {
  ...
  if (operator === ',') {
    ...
    //  the top level comma has relevance.
    if (this.angularOperatorStack.length === 0) {
...
describe('$$ngMessageFormat', function() {
  describe('core', function() {
    ...
    describe('mustache', function() {
      ...
      describe('watchable', function() {
        ...
        it('should stop watching strings with  constant expressions after first execution', function() {
          var spy = jasmine.createSpy();
  ...
  describe('$interpolate', function() {
    ...
    it('should return the interpolation object when there are no bindings and text is undefined',
    ...
    it('should return undefined when there are no bindings and text is set to true',
        inject(function($interpolate) {
    ...
    describe('watching', function() {
      ...
      it('should stop watching strings with  constant expressions after first execution',
        inject(function($interpolate, $rootScope) {
          var spy = jasmine.createSpy();
