...
var swipeTests = function(description, restrictBrowsers, startEvent, moveEvent, endEvent) {
  describe('ngSwipe with ' + description + ' events', function() {
    ...
    it('should  swipe given ng-swipe-disable-mouse attribute for touch events', inject(function($rootScope, $compile) {
    ...
    it('should not swipe if you slide  a short distance', inject(function($rootScope, $compile, $rootElement) {
      element = $compile('<div ng-swipe-left="swiped = true"></div>')($rootScope);
      $rootElement.append(element);
      $rootScope.$digest();
...
describe('$swipe', function() {
  ...
  describe('pointerTypes', function() {
    ...
    it('should  use mouse events for pointerType "mouse"', inject(function($swipe) {
      $swipe.bind(element, events, ['mouse']);
      expect(usedEvents.sort()).toEqual(MOUSE_EVENTS);
    }));

    it('should  use touch events for pointerType "touch"', inject(function($swipe) {
      $swipe.bind(element, events, ['touch']);
      expect(usedEvents.sort()).toEqual(TOUCH_EVENTS);
    }));

    it('should  use pointer events for pointerType "pointer"', inject(function($swipe) {
