 ...
 *     If not specified, then  POST, PUT and PATCH requests will have a body. *
 ...
 *   should have a body). By default,  actions using `POST`, `PUT` or `PATCH` have request
        ...
        forEach(actions, function(action, name) {
          ...
          if (numericTimeout && !isNumber(numericTimeout)) {
            $log.debug('ngResource:\n' +
                       '   numeric values are allowed as `timeout`.\n' +
