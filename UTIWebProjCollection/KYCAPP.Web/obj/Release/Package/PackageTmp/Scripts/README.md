...
\*: Bower isn't officially supported, it can be used to install Tooltip.js  trough the unpkg.com CDN. This method has the limitation of not being able to define a specific version of the library. Bower and Popper.js suggests to use npm or Yarn for your projects.  
