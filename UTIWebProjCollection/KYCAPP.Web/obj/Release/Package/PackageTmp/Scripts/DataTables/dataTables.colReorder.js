...
$.extend( ColReorder.prototype, {
	...
	"_fnMouseMove": function ( e )
	{
		...
		{
			/*  create the drag element if the mouse has moved a specific distance from the start
	...
	"_fnRegions": function ()
	{
		...
		for ( var i=0, iLen=aoColumns.length ; i<iLen ; i++ )
		{
			 ...
			 * position is just to it's immediate left or right, so we  increment the counter for
			 * other columns
			 */
