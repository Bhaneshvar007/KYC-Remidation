 ...
 * is that  the visible portion of the table (and a bit to either side to make
...
var Scroller = function ( dt, opts ) {
	...
	//  held in the `s` property. At the moment they are mixed
...
$.extend( Scroller.prototype, {
	...
	*/
	...
	"_fnScroll": function ()
	{
		 ...
		 * handed, so use a timeout to update the state saving  when the
		...
		if ( iScrollTop < this.s.redrawTop || iScrollTop > this.s.redrawBottom ) {
			...
			if ( iTopRow <= 0 ) {
				...
				// For the row-striping classes (odd/even) we want  to start
	...
	"_fnDrawCallback": function ()
	{
		...
		// needed.   add the thread break if bInfo is set
	 ...
	 *  to that maximum value and virtual / physical domain transforms will
